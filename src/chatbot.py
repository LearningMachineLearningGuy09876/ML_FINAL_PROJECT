...
class MovieChatbot:
    ...
    Features:
    - Understands genres, moods, decades, years, and negative preferences.
    ...
    QUALITY_WORDS = ["best", "top", "popular", "highest", "great", "good", "strong ratings", "well rated"]
    ...
    def explain_movie(self, row, parsed):
        ...
        if parsed.get("year_max") and pd.notna(year):
            reasons.append(f"fits your older/classic preference")
    ...
    def recommend(self, query, top_n=10, mood=None):
        ...
        if similar is not None:
            ...
            if parsed["genres"] or parsed["excluded_genres"] or parsed["year"] or parsed["year_min"] or parsed["year_max"] or parsed["decade"]:
